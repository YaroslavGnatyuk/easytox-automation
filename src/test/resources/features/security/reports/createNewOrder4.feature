...
#Case Finalize
    ...
    When Under Test Screen section, select concentration for 'Compound1' such that test results are "Negative Result".
    ...
    When Under Validity Testing section, select concentration for 'VCompound1' in such a way that test results are "Abnormal Result".
    Then Selections should be made as appropriately for 'VCompound1'.

    When Under Validity Testing section, select concentration for 'VCompound2' in such a way that test results are "Abnormal Result".
