package com.easytox.automation.steps.security.search.calvine;
...
public class SearchForCalvinePatientSteps {
    ...
    private Logger log = Logger.getLogger(SearchForCalvinePatientSteps.class);
    ...
    private void initPatients() {
        ...
        junkData = Stream.of(new String[]{
                ...
                "Raja Raman lastName","madhu madhu"
        }).collect(Collectors.toList());
    }
}
