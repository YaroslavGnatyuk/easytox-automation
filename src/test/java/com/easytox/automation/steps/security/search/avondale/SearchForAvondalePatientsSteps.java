package com.easytox.automation.steps.security.search.avondale;
...
public class SearchForAvondalePatientsSteps {
    ...
    private Logger log = Logger.getLogger(SearchForAvondalePatientsSteps.class);
