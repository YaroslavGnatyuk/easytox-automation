package com.easytox.automation.steps.security.search.bansal;
...
public class SearchForBansalPatientSteps {
    ...
    private Logger log = Logger.getLogger(SearchForBansalPatientSteps.class);
