package com.easytox.automation.steps.security.search.caster;
...
public class SearchForCasterPatientSteps {
    ...
    private Logger log = Logger.getLogger(SearchForCasterPatientSteps.class);
