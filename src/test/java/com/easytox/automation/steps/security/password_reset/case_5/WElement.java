...
/**
 * I hold here web elements for test -> Security framework test scenarios (use in ResetPasswordForLabAdminSteps.java)
 **/
...
interface WElement {
    ...
    String loginDropDown = "body > div.navbar > div > div > div.navbar-header.pull-right > div > ul > li:nth-child(2) > a";
